...
position: fixed; top: 0; bottom: 0; background: #2d2f3e; width: 10rem; overflow-y: auto; overflow-x: hidden; animation: sidebar-slide-right 0.8s; z-index: 1030; font-weight: 300;">
    ...
    <div class="pestañas"> 
        ...
        <a href="../subirPrecio">
        <button class="pestaña" style="width:250px; border: none;">Aumento por Venta</button>
        </a>
        <a href="../subirPrecio/compra.php">
        <button class="pestaña" style="width:250px; border-top-right-radius: 10px; background-color: #2d2f3e2e; color: #535561;">Aumento por Compra</button>
        </a>
    </div>
