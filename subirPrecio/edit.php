...
box-shadow: 0 1px 15px 1px rgba(60, 55, 68, 0.15);">
			...
			* INNER JOIN product_brands AS marca ON marca.id = pro.brand_id
			...
			$sql = mysqli_query($con, "SELECT pro.id, pro.title, grupo.name as group_id, pre.selling_price as precio
			...
			if(isset($_POST['save'])){
				...
				$update = mysqli_query($con, "UPDATE product_variants 
												...
												SET product_variants.selling_price = 
												ROUND(('$aumento'/100 * product_variants.selling_price) + product_variants.selling_price)
			...
			?>
			<h2> <a  href="index.php">Lista de Grupos</a> &raquo; Grupo <?php echo $row ['group_id']; ?> &raquo; Lista de productos</h2>
			<hr />
			...
			<form class="form-horizontal" action="" method="post">
				<div class="form-group">
					...
					<div class="col-sm-6">
						...
						<a href="index.php" class="btn btn-sm btn-danger" style="border-style: none;padding: 10px;font-size: 15px;">Cancelar</a>
					</div>
				</div>
				<!--<div class="form-group">
					<label class="col-sm-5 control-label">&nbsp;</label>
